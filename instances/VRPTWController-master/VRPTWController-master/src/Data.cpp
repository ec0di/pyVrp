...
Data::Data(int argc, char* arguments[]) {
    ...
    this->passMark       = atoi(arguments[3]);
    this->baseTimeLimit  = atof(arguments[4]);
    this->euc_2d            = "0";
    this->bestKnownSolution = atof(arguments[5]);
...
string Data::getNameOfOutputFile() {
    return "DIMACS-VRPTW-" + competitorName + "-" + instance.name + ".out";
}
